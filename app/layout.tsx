          ...
          <div className="container mx-auto px-4 py-12 md:py-16">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/pengaturan" className="hover:text-white transition-colors">Tentang Kami</Link></li>
                  <li><Link href="/pengaturan" className="hover:text-white transition-colors">Blog</Link></li>
                  <li><Link href="/konten" className="hover:text-white transition-colors">Artikel & Konten</Link></li>
                  <li><Link href="/pengaturan" className="hover:text-white transition-colors">FAQ</Link></li>
                </ul>
              </div>
